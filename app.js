...
function photoFor(talent) {
  return talent.photo || getLocalPhotoFor(talent.id) || '';
}
...
function renderTalentForm(v) {
  ...
  document.getElementById('form-body').innerHTML = `
    ...
    <div class="field full">
      ...
      <div class="field-hint">⚠ Une photo importée depuis l'appareil reste locale : elle ne sera pas visible par le reste de l'équipe. Pour que tout le monde la voie, utilise un lien URL (ex: partage Google Drive, Imgur).</div>
